    ...
    <CardContent>
      {requirements.length > 0 ? (
        ...
        <p className="text-muted-foreground text-sm">
          No {title.toLowerCase()} requirements.
        </p>
      )}
    </CardContent>
  </Card>
...
export default function ReportPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.error(
        "Failed to load from local storage or generate report",
        error
      );
      router.push("/");
    }
    ...
    <div className="bg-background min-h-screen">
      ...
      <main className="max-w-5xl mx-auto p-4 md:p-8 lg:p-12 print-container">
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent>
              <GeneratedSectionContent
                {...summaryState}
                onRetry={() => fetchSummary(requirements)}
              />
            </CardContent>
          </Card>
            ...
            <Card>
              ...
              <CardContent>
                <GeneratedSectionContent
                  {...diagramState}
                  isDiagram={true}
                  onRetry={() => fetchDiagram(requirements)}
                />
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <GeneratedSectionContent
                  {...estimationState}
                  onRetry={() => fetchEstimation(requirements)}
                />
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl md:text-2xl">References</CardTitle>
            </CardHeader>
            <CardContent>
              <GeneratedSectionContent
                {...referencesState}
                onRetry={() => fetchReferences(conversationHistory)}
              />
            </CardContent>
          </Card>
        </div>
