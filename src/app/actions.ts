...
export async function extractRequirements(
  ...
  try {
    ...
    return {
      error:
        error.message ||
        "Failed to extract requirements due to an unexpected error.",
    };
  }
}
...
export async function getAiChatResponse(
  ...
  try {
    ...
    return {
      error:
        error.message ||
        "Failed to get AI response due to an unexpected error.",
    };
  }
}
...
export async function getAiSpeechResponse(
  text: string
